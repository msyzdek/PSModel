  ...
  return (
    <ProtectedRoute>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <Link href="/holders" className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <svg
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Manage Holders</dt>
                  <dd className="text-sm text-blue-600 font-medium mt-1">View all →</dd>
                </dl>
              </div>
            </div>
          </div>
