...
- [ ] 8. Enhance PeriodService to work with holder entities
...
- [ ] 9. Update Period schemas to support holder selection
...
- [ ] 10. Create frontend Holder type definitions and API client
...
- [ ] 11. Create HolderForm component
...
- [ ] 12. Create HolderList component
...
- [ ] 13. Create Holder management page
...
- [ ] 14. Create HolderSelector component
...
- [ ] 15. Enhance PeriodForm to use HolderSelector
...
- [ ] 16. Implement "Copy from Previous Period" functionality
...
- [ ] 17. Create multi-period grid data API endpoint
...
- [ ] 18. Create grid cell update API endpoint
...
- [ ] 19. Create MultiPeriodGrid types and utilities
...
- [ ] 21. Create MultiPeriodGrid component
...
- [ ] 22. Create multi-period grid page
...
- [ ] 23. Add navigation links to holder management and grid view
  ...
  - Update home page to include links to new features
  - _Requirements: 1.1, 6.1_

- [ ] 24. Update period detail page to show holder information
...
- [ ]* 25. Write backend integration tests
